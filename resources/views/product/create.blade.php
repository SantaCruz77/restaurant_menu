    ...
    <div class="container mt-3" style="max-width: 720px;" >
        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" >
            ...
            <div class="text-right mt-2">
                <a type="button" href="{{ '/category/create' }}" class="btn btn-outline-secondary py-1" role="button">新規追加</a>
                <a type="button" href="{{ '/category/' }}" class="btn btn-outline-secondary py-1" role="button">編集</a>
            </div>
            <div class="form-group" style="margin-bottom: 30px" >
